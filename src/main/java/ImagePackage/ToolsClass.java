...
//            ImageIO.write(croppedImage,"jpg", new File("C:\\Users\\egypt2\\Desktop\\test.jpg"));
        ...
        public BufferedImage rotateImage(BufferedImage bufferedImage, Double angle ) {
            ...
            BufferedImage rotated = new BufferedImage(neww, newh, bufferedImage.getType());
        ...
        public BufferedImage zoomImage(BufferedImage bufferedImage, int zoomLevel){

            int imageWidth = bufferedImage.getWidth();
            int imageHeight = bufferedImage.getHeight();
            int newImageWidth = imageWidth * zoomLevel;
            int newImageHeight = imageHeight * zoomLevel;
            BufferedImage resizedImage = new BufferedImage(newImageWidth, newImageWidth, bufferedImage.getType());
